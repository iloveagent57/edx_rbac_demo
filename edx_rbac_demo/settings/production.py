...
from edx_rbac_demo.settings.base import *
from edx_rbac_demo.settings.utils import get_env_setting
...
# This may be overridden by the YAML in edx_rbac_demo_CFG,
# but it should be here as a default.
MEDIA_STORAGE_BACKEND = {}
FILE_STORAGE_BACKEND = {}

CONFIG_FILE = get_env_setting('EDX_RBAC_DEMO_CFG')
