...
SECRET_KEY = os.environ.get('EDX_RBAC_DEMO_SECRET_KEY', 'insecure-secret-key')
...
PROJECT_APPS = (
    'edx_rbac_demo.apps.core',
    'edx_rbac_demo.apps.api',
)
...
ROOT_URLCONF = 'edx_rbac_demo.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'edx_rbac_demo.wsgi.application'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': (
                ...
                'edx_rbac_demo.apps.core.context_processors.core',
            ),
...
SESSION_COOKIE_NAME = 'edx_rbac_demo_sessionid'
CSRF_COOKIE_NAME = 'edx_rbac_demo_csrftoken'
LANGUAGE_COOKIE_NAME = 'edx_rbac_demo_language'
