...
"""
edx_rbac_demo documentation build configuration file.
...
VERSION = get_version('../edx_rbac_demo', '__init__.py')
...
project = 'edx_rbac_demo'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'edx_rbac_demo'
...
#
# html_title = 'edx_rbac_demo v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Demo of edx-rbac',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx_rbac_demo'),
                os.path.join(root_path, 'edx_rbac_demo/migrations')])
